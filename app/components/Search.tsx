...
import { BASE_API_URL } from "@/lib/utils"; // Assuming your API URL is set up here
...
const Search: React.FC<Props> = ({ regions = [] }) => {
  ...
  // Filter users whenever the search input changes
  useEffect(() => {
    if (!users) return; // Ensure users are defined
